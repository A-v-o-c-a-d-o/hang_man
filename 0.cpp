...
void setSprite(Sprite& sprite, string path, Vector2f pos, Vector2f scale)
{
...
struct Button
{
    ...
    {
        font.loadFromFile("D:\\Workspace\\Code\\SFML\\Need_file\\font-times-new-roman.ttf");
        text.setFont(font);
        text.setString(str);
...
struct Game
{
    ...
    Text chooseTopic;
    Button topic[6];
    string path[6] =   {"D:\\Workspace\\Code\\SFML\\Need_file\\animal.txt", "D:\\Workspace\\Code\\SFML\\Need_file\\fruit.txt",
                        "D:\\Workspace\\Code\\SFML\\Need_file\\landscape.txt", "D:\\Workspace\\Code\\SFML\\Need_file\\plant.txt",
                        "D:\\Workspace\\Code\\SFML\\Need_file\\vegetable.txt", "D:\\Workspace\\Code\\SFML\\Need_file\\weather.txt"};
    ...
    void update(RenderWindow& window, Event event)
    {
        ...
        {
            case 0:
                backMusic.openFromFile("D:\\Workspace\\Code\\SFML\\Need_file\\Proud-of-you.wav");
            ...
            case 1:
                for(int i=0; i<6; i++)
                    if(topic[i].clicked(window))
                    {
                        ...
                        {
                            posArr.push_back(Vector2f(10+i*(340/turn), 300));
                        }
                        suggestMode = false;
                        betMode = false;
                        strWrong = "";
                        ...
                        setText(textBet, font, strBet, Vector2f(270, 300), 30, Color::White, Vector2f(1, 1));
                        setText(textSuggest, font, "", Vector2f(350, 300), 25, Color::White, Vector2f(1, 1));
                        ...
                        setSprite(zombie, "D:\\Workspace\\Code\\SFML\\Need_file\\Zombie.png", Vector2f(350, 300), Vector2f(0.1, 0.1));
                        setSprite(brain, "D:\\Workspace\\Code\\SFML\\Need_file\\Brain.png", Vector2f(10, 450), Vector2f(0.2, 0.2));
                        stage++;
                        break;
                    }
                break;
            case 2:
                zombie.setPosition(posArr[turn]);
...
// cd "d:\Workspace\Code\SFML\Code_file\" ; if ($?) { g++ 0.cpp -o 0 -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio} ; if ($?) { .\0 }